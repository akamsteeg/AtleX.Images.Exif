...
namespace AtleX.Images.Exif.Readers.Jpeg
{
    ...
    public class JpegExifReader : ExifReader
    {
        ...
        public override IEnumerable<ExifValue> GetExifData()
        {
            ...
            IEnumerable<RawJpegSegment> segments = ParseHeaderIntoSegments(bReader);
        ...
        /// <returns></returns>
        private static IEnumerable<RawJpegSegment> ParseHeaderIntoSegments(BinaryReader reader)
        {
            if (reader == null)
